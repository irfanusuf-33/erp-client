...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-900">
      <div className="w-full bg-white dark:bg-zinc-900 min-h-screen">
        ...
        <div className="flex items-start justify-between px-8 pt-8 pb-4">
          <div className="flex items-start gap-5">
            ...
            <div className="relative flex-shrink-0">
              ...
              {/* Online/clock badge */}
              <div className="absolute bottom-0 right-0 w-6 h-6 rounded-full bg-yellow-400 border-2 border-white dark:border-zinc-800 flex items-center justify-center">
            ...
            {/* Name + action icons */}
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-2">{fullName}</h1>
          ...
          {/* Close button */}
          <button onClick={() => router.back()} className="text-gray-400 dark:text-zinc-400 hover:text-gray-600 dark:hover:text-slate-300 transition-colors mt-1">
        ...
        {/* Tabs */}
        <div className="flex border-b border-gray-200 dark:border-zinc-800 px-8">
          {tabs.map((tab) => (
            <button
              key={tab}
              ...
              className={`px-4 py-3 text-sm font-medium transition-colors border-b-2 -mb-px ${
                activeTab === tab
                  ...
                  : "border-transparent text-gray-500 dark:text-zinc-400 hover:text-gray-700 dark:hover:text-slate-300"
              }`}
            >
              {tab}
            </button>
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          {activeTab === "Overview" && (
            <>
              {/* Quick message */}
              <div className="flex items-center gap-3 bg-gray-50 dark:bg-zinc-900 rounded-lg px-4 py-3 border border-gray-200 dark:border-zinc-800">
                <input
                  type="text"
                  placeholder="Send a quick message"
                  value={message}
                  onChange={(e) => setMessage(e.target.value)}
                  className="flex-1 bg-transparent text-sm text-gray-600 dark:text-zinc-300 outline-none placeholder:text-gray-400 dark:placeholder:text-slate-500"
                />
                <button className="text-gray-400 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-500 transition-colors">
              ...
              {/* Status cards */}
              <div className="border border-gray-200 dark:border-zinc-800 rounded-lg divide-y divide-gray-100 dark:divide-zinc-800">
                <div className="flex items-start gap-3 px-4 py-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-zinc-400 mt-0.5">Work hours: 08:00 – 17:00</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 px-4 py-3">
                  <svg className="w-5 h-5 text-gray-400 dark:text-zinc-400 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0z" />
                  </svg>
                  <p className="text-sm text-gray-600 dark:text-zinc-300">{timeStr} – Same time zone as you</p>
                </div>
              </div>

              {/* Contact information */}
              <div>
                <h2 className="text-base font-bold text-gray-900 dark:text-zinc-100 mb-4">Contact information</h2>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-gray-400 dark:text-zinc-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 0 0 2.22 0L21 8M5 19h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2z" />
                    </svg>
                    <div>
                      <p className="text-xs text-gray-400 dark:text-zinc-400 mb-0.5">Email</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-400 dark:text-zinc-400 mb-0.5">Chat</p>
                ...
                {showMoreContact && (
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 dark:text-zinc-400 mb-0.5">Phone</p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 dark:text-zinc-400 mb-0.5">Location</p>
                        <span className="text-sm text-gray-700 dark:text-zinc-300">Karachi, Pakistan</span>
                      </div>
                    </div>
                  </div>
                )}
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 className="text-base font-bold text-gray-900 dark:text-zinc-100">LinkedIn</h2>
                </div>
                ...
                {showLinkedIn && (
                  <div className="mt-3 p-4 bg-gray-50 dark:bg-zinc-900 rounded-lg border border-gray-200 dark:border-zinc-800">
                    <p className="text-sm text-gray-600 dark:text-zinc-400">LinkedIn profile URL not configured.</p>
                  </div>
                )}
              </div>
            </>
          ...
          {activeTab === "Contact" && (
            <div className="space-y-5">
              <h2 className="text-base font-bold text-gray-900 dark:text-zinc-100">Contact Details</h2>
              {[
                ...
                <div key={label} className="flex items-center gap-4 py-3 border-b border-gray-100 dark:border-zinc-800">
                  <svg className="w-5 h-5 text-gray-400 dark:text-zinc-400 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d={icon} />
                  </svg>
                  <div>
                    <p className="text-xs text-gray-400 dark:text-zinc-400">{label}</p>
                    <p className="text-sm text-gray-800 dark:text-zinc-100 font-medium">{value}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          {activeTab === "Organization" && (
            <div className="space-y-5">
              <h2 className="text-base font-bold text-gray-900 dark:text-zinc-100">Organization</h2>
              {[
                ...
                <div key={label} className="flex items-center justify-between py-3 border-b border-gray-100 dark:border-zinc-800">
                  <span className="text-sm text-gray-500 dark:text-zinc-400">{label}</span>
                  <span className="text-sm font-medium text-gray-800 dark:text-zinc-100">{value}</span>
                </div>
              ))}
            </div>
          )}
          ...
          {activeTab === "LinkedIn" && (
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-base font-bold text-gray-900 dark:text-zinc-100">LinkedIn Profile</h2>
              </div>
              <p className="text-sm text-gray-700 dark:text-zinc-300 leading-relaxed">
                I'm a web developer with a passion for crafting seamless digital experiences.{" "}
                <span className="text-blue-600 dark:text-blue-500">I'm fluent in HTML, CSS, Javascript, C#, C / C++</span>
              ...
              <div className="bg-gray-50 dark:bg-zinc-900 rounded-lg p-4 border border-gray-200 dark:border-zinc-800 space-y-2">
                <p className="text-xs text-gray-400 dark:text-zinc-400 uppercase tracking-wide font-medium">Skills</p>
