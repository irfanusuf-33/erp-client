        ...
        <div className="flex items-start justify-between px-8 pt-8 pb-4">
          <div className="flex items-start gap-5">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-20 h-20 rounded-full bg-pink-100 flex items-center justify-center text-2xl font-bold text-pink-600 select-none">
                {initials}
              </div>
              {/* Online/clock badge */}
              <div className="absolute bottom-0 right-0 w-6 h-6 rounded-full bg-yellow-400 border-2 border-white flex items-center justify-center">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                {/* LinkedIn */}
                <button className="text-blue-700 hover:text-blue-800 transition-colors" title="LinkedIn">
          ...
          {/* Close button */}
          <button onClick={() => router.back()} className="text-gray-400 hover:text-gray-600 transition-colors mt-1">
            ...
            <>
              ...
              <div className="border border-gray-200 rounded-lg divide-y divide-gray-100">
                <div className="flex items-start gap-3 px-4 py-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Work hours: 08:00 – 17:00</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 px-4 py-3">
                  ...
                  <p className="text-sm text-gray-600">{timeStr} – Same time zone as you</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-400 mb-0.5">Chat</p>
                      <a href="#" className="text-sm text-blue-600 hover:underline">{email}</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-sm text-blue-600">+1 (555) 000-0000</span>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  ...
                  <span className="text-blue-600">I'm fluent in HTML, CSS, Javascript, C#, C / C++</span>
                ...
                {showLinkedIn && (
                  <div className="mt-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <p className="text-sm text-gray-600">LinkedIn profile URL not configured.</p>
                  </div>
                )}
              </div>
            </>
          ...
          {activeTab === "Contact" && (
            <div className="space-y-5">
              ...
              {[
                ...
                <div key={label} className="flex items-center gap-4 py-3 border-b border-gray-100">
                  <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
          ...
          {activeTab === "LinkedIn" && (
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-base font-bold text-gray-900">LinkedIn Profile</h2>
              </div>
              <p className="text-sm text-gray-700 leading-relaxed">
                I'm a web developer with a passion for crafting seamless digital experiences.{" "}
                <span className="text-blue-600">I'm fluent in HTML, CSS, Javascript, C#, C / C++</span>
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 space-y-2">
                <p className="text-xs text-gray-400 uppercase tracking-wide font-medium">Skills</p>
                <div className="flex flex-wrap gap-2">
                  {["HTML", "CSS", "JavaScript", "TypeScript", "React", "Next.js", "Node.js", "C#", "ASP.NET"].map((skill) => (
                    <span key={skill} className="px-2 py-1 bg-blue-50 text-blue-700 text-xs rounded-full font-medium">{skill}</span>
                  ))}
                </div>
              </div>
