...
export default function IamUserDetails() {
  ...
  const handleToggleStatus = async () => {
    ...
    try {
      ...
      if (res?.success) { showSuccess(user.disabled ? "User Enabled" : "User Disabled"); setUser((p: any) => ({ ...p, disabled: !p.disabled })); }
    } catch { showError("Action Failed", "Failed to update user status"); }
