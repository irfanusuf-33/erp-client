    ...
    switch (activeTab) {
      ...
      case 'procurement':
        return <PlaceholderSection 
          ...
          icon={<ShoppingBag className="w-10 h-10 text-blue-600 dark:text-blue-400" />}
        />;
      case 'approvals':
        return <PlaceholderSection 
          title="Approvals & Tasks" 
          description="Review pending approvals and manage your task assignments"
          icon={<CheckSquare className="w-10 h-10 text-blue-600 dark:text-blue-400" />}
        />;
      case 'analytics':
        return <PlaceholderSection 
      ...
      case 'team':
        return <PlaceholderSection 
          ...
          description="Monitor team performance metrics and collaboration"
