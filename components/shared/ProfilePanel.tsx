...
export default function ProfilePanel({ open, onClose, onOpenSettings, onOpenNotifications }: ProfilePanelProps) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed top-0 right-0 h-full w-full sm:w-[420px] bg-white dark:bg-slate-900 shadow-2xl z-[101] flex flex-col animate-slide-in-right">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="py-2">
            <button
              ...
              className="w-full flex items-center gap-3 px-6 py-3 text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-6 py-3 text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors"
            >
              <CheckSquare className="w-5 h-5 text-gray-500 dark:text-slate-400" />
          ...
          <div className="py-2">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-6 py-3 text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors"
            >
              <Puzzle className="w-5 h-5 text-gray-500 dark:text-slate-400" />
