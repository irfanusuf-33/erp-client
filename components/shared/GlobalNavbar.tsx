...
export default function GlobalNavbar() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-50 w-full h-16 bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800">
        ...
        <div className="h-full mx-auto flex items-center justify-between px-10 py-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-gray-700 dark:text-zinc-300 hover:text-gray-900 dark:hover:text-slate-100 transition-colors w-10 h-10 flex items-center justify-center rounded-md focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-blue-500"
            >
          ...
          <div className="flex items-center gap-3">
            {/* Search Bar */}
            <div className="flex items-center gap-2 bg-gray-100 dark:bg-zinc-800 rounded-lg px-3 py-2 w-64">
              <svg className="w-4 h-4 text-gray-500 dark:text-zinc-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-4.35-4.35M17 11A6 6 0 1 1 5 11a6 6 0 0 1 12 0z" />
              </svg>
              <input
                type="text"
                placeholder="Search..."
                className="text-gray-700 dark:text-zinc-300 text-sm bg-transparent outline-none w-full placeholder:text-gray-500 dark:placeholder:text-slate-500"
              />
            </div>
